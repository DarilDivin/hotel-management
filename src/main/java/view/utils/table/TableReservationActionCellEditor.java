...
public class TableReservationActionCellEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    private TableReservationActionCellListener listener;

    public TableReservationActionCellEditor() {
        ...
        btnValider.addActionListener(e -> {
            if (listener != null && table != null) {
                listener.onValider(table.getSelectedRow());
            }
            fireEditingStopped();
        });

        panel.add(btnValider, "gap 5");
        panel.add(btnModifier, "gap 5");
        panel.add(btnSupprimer, "gap 5");
    }

    public void setTableButtonsListener(TableReservationActionCellListener listener) {
